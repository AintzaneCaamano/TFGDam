...
public class SimonActivity extends AppCompatActivity  implements View.OnClickListener{
    ...
    private TextView txtLifeCounter;
    ...
    private boolean earnLife = false;
    private int sequenceLength=3;
    private int userControl=1;
    private int achieveExtraLife=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtLifeCounter = findViewById(R.id.txtV_simon_lifeCounter);
        imgLife = findViewById(R.id.img_simon_heart1);

        showScore();
        txtLifeCounter.setVisibility(View.INVISIBLE);
        ...
        if(continuePlaying) {
            ...
            if (userControl < sequenceLength) {
                ...
                if(!sequenceManager.checkSequence(userSequence)){
                    ...
                    lifes=lifes-1;
                    imgLife.setImageResource(R.drawable.heart_icon_grey);
                    txtLifeCounter.setVisibility(View.VISIBLE);
                    txtLifeCounter.setText(String.valueOf(achieveExtraLife));
                    if(lifes<0) {
    ...
    private void getExtraLife(){
        if (achieveExtraLife<2){
            ...
            achieveExtraLife=0;
            earnLife=false;
            imgLife.setImageResource(R.drawable.heart_icon);
            lifes++;
        }
    }
}